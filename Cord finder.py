...
def change_cell():
    ...
    # Update a specific cell with the word "hello"
    cell = 'A1'  # Replace with the desired cell location
    wks.update(range_name=cell, values=[["hello"]])

    print(f"Updated cell {cell} with the word 'hello'")
